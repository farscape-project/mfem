...
function(mfem_export_mk_files)
  ...
  if (BUILD_SHARED_LIBS)
    set(MFEM_LIBS "${shared_link_flag}\$(MFEM_LIB_DIR)")
    set(MFEM_SHARED YES)
    set(MFEM_STATIC NO)
  else()
    set(MFEM_SHARED NO)
  ...
  set(MFEM_LIBS "${MFEM_LIBS} -L\$(MFEM_LIB_DIR)")
  set(MFEM_LIBS "${MFEM_LIBS} -l$<TARGET_FILE_BASE_NAME:${PROJECT_NAME}>")
  set(MFEM_LIBS "${MFEM_LIBS} \$(MFEM_EXT_LIBS)")
  set(MFEM_LIB_FILE $<TARGET_FILE:${PROJECT_NAME}>)
